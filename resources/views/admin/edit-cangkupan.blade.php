...
@endif
     ...
     <div class="page-wrapper mdc-toolbar-fixed-adjust">
        <main class="content-wrapper">
            <form action="/update_cangkupan" method="post">
              @csrf
          <div class="mdc-layout-grid">
            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell--span-12">
                ...
                <div class="mdc-card p-0 "> 
                  ...
                  <div class="card-header text-white" style="text-align: center; background-color: #291D5B;">   
                      <h3 style="color: white;"><b>Form Edit Gejala</b></h3>
              ...
              <form class="form-horizontal" role="form">
                ...
                @foreach($kirimdata as $data)
                <div class="form-group">
                  <label for="password1" class="col-sm-2 control-label">Kode Gejala:</label>
                  <div class="col-sm-5 s">
                    <input type="text" class="form-control inputstl" id="password1" value="{{$data->kode_gejala}}" name="kode_gejala" readonly> 
                  </div>
                </div>
                <div class="form-group">
                  <label for="email1" class="col-sm-2 control-label">Nama Gejala:</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control inputstl" id="email1" value="{{$data->nama_gejala}}" name="nama_gejala">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control inputstl" id="email1" value="{{$data->bobot_gejala}}" name="bobot_gejala">
                ...
                <div class="table-responsive">
                    <table class="table ">
                      ...
                      <tbody>
                        ...
                        <td style="width: 80px;" ><input type="text" style="width: 80px;" value="{{$data->bobotP001}}" name="bobotP001"></td>
                        <td style="width: 80px;" ><input type="text" style="width: 80px;" value="{{$data->bobotP002}}" name="bobotP002"></td>
                        <td style="width: 80px;" ><input type="text" style="width: 80px;" value="{{$data->bobotP003}}" name="bobotP003"></td>
                        <td style="width: 80px;" ><input type="text" style="width: 80px;" value="{{$data->bobotP004}}" name="bobotP004"></td>
                        <td style="width: 80px;" ><input type="text" style="width: 80px;" value="{{$data->bobotP005}}" name="bobotP005"></td>
                        <td style="width: 80px;" ><input type="text" style="width: 80px;" value="{{$data->bobotP006}}" name="bobotP006"></td>
                        <td style="width: 80px;" ><input type="text" style="width: 80px;" value="{{$data->bobotP007}}" name="bobotP007"></td>
                        <td style="width: 80px;" ><input type="text" style="width: 80px;" value="{{$data->bobotP008}}" name="bobotP008"></td>
                        <td style="width: 70px;" ><input type="text" style="width: 70px;" value="{{$data->bobotP009}}" name="bobotP009"></td>

            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                ...
                <div class="card">  
                    ...
                    <h4 class="text-uppercase text-center">Validasi Data Oleh Ahli</h4>    
                        ...
                        <div class="card-body">  
                            ...
                            @endif
                                <div class="form-row">  
                                    <div class="col-md-6">  
                                        <label>Nama Ahli (Nama Lengkap berserta gelar)</label>  
                                        <input type="text" placeholder="Masukan Nama" class="form-control" name="nama" required/>  
                                    </div>  
                                    <div class="col-md-6">  
                                ...
                                <div class="form-row">  
                                    <div class="col-md-6">  
                                        <label>Upload Foto Ttd (Tanda Tangan)</label>  
                                        <input type="file" placeholder="Enter Your Website" class="form-control" name="file_ttd" required/>  
                                    </div>  
                                    <div class="col-md-6">  
                                        <label>Upload Foto Stample (Bisa diganti oleh foto selfi Ahli)</label>  
                                        <input type="file" placeholder="Password" class="form-control" name="file_foto" required/>  
                                    </div>  
                                </div>  
